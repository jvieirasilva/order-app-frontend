...
export default function OrderProductCard({ product, onClick }: ProductCardProps) {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [isHovering, setIsHovering] = useState(false);

  // ✅ PROTEÇÃO: Verifica se product existe e tem imagens
  if (!product) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <div className="position-relative" style={{ height: "250px", overflow: "hidden" }}>
        {hasImages ? (
          <ImageZoom
            ...
            // ❌ SEM onImageClick aqui - só mostra zoom, não abre lightbox
          />
        ) : (
      ...
      <div className="card-body d-flex flex-column">
        <h6 className="card-title text-truncate mb-2" title={product.name || "Produto"}>
