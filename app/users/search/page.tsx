...
export default function SearchUsersPage() {
  ...
  try {
    ...
    // ✅ CORRIGIR - O backend retorna 'active' e 'notLocked' (sem o 'is')
  ...
  async function handleSaveEdit(e: React.FormEvent) {
    ...
    try {
      ...
      await updateUser(userToEdit.id, {
        ...
        role: editRole,
        password: editPassword || undefined, // Só envia se tiver valor
        isActive: editIsActive,
        isNotLocked: editIsNotLocked,
        isChangePassword: !!editPassword, // true se mudou a senha
 ...
 return (
    ...
    <>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1>Search Users</h1>
        <button className="btn btn-primary" onClick={() => router.push('/users/register')}>+ New User</button>
      </div>
